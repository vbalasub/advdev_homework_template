...
oc set volume dc/tasks --add --name=jboss-config --mount-path=/opt/eap/standalone/configuration/application-users.properties  --configmap-name=tasks-config -n ${GUID}-tasks-dev
...
oc set volume dc/tasks --add --name=jboss-config1 --mount-path=/opt/eap/standalone/configuration/application-roles.properties  --configmap-name=tasks-config -n ${GUID}-tasks-dev
