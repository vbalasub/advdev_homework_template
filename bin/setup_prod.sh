...
#oc set volume dc/tasks-blue --add --name=jboss-config --mount-path=/opt/eap/standalone/configuration/application-users.properties --configmap-name=tasks-blue-config -n ${GUID}-tasks-prod
...
#oc set volume dc/tasks-blue --add --name=jboss-config1 --mount-path=/opt/eap/standalone/configuration/application-roles.properties --configmap-name=tasks-blue-config -n ${GUID}-tasks-prod
...
oc set volume dc/tasks-green --add --name=jboss-config --mount-path=/opt/eap/standalone/configuration/application-users.properties  --configmap-name=tasks-green-config -n ${GUID}-tasks-prod
...
oc set volume dc/tasks-green --add --name=jboss-config1 --mount-path=/opt/eap/standalone/configuration/application-roles.properties --configmap-name=tasks-green-config -n ${GUID}-tasks-prod
